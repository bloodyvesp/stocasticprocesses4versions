...
Las martingalas que obtenemos de derivar directamente a $M_t^\lambda$ (no us\'e polin\'omio de Hermite sino que derive directamente $M_t^\lambda$ usando un software para derivar) :
$$
N_t-\gamma t
$$
$$
...
$$
 ...
 \paren{B_{n+t}-B_n, n \in \na }
  ...
  $$
  Entonces el proceso $\paren{B^n_t=B_{n+t}-B_n, t\in [0,1]}$  tiene trayectorias independientes para cada n, de donde tomando supremos conciu\'imos que en efecto:
  $$
  \paren{\sup_{t\in [0,1]}\abs{B_{n+t}-B_n},n\in\na} 
  $$
