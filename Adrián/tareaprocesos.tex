...
\begin{esn}
\frac{\partial^n}{\partial \lambda^n}g(h(\lambda))=\paren{h^{(1)}(\lambda)}^n g^{(n)}(h(\lambda))
\end{esn}
...
\begin{esn}
\frac{\partial^n}{\partial\lambda^n}e^{-\frac{1}{2}\paren{\frac{B_t}{\sqrt{t}}-\lambda\sqrt{t}}^2}=\paren{-\sqrt{t}}^n(-1)^nH_n(h(\lambda))e^{-h(\lambda)^2/2}
\end{esn}
...
Por lo tanto;
\begin{esn}
\esp{B_{T_{a,b}}^2{T_{a,b}}}=a^2\paren{ab-\frac{b^3a-a^3b}{3(a+b)}-\frac{a^2b}{a+b}}+b^2\paren{\frac{b^3a-a^3b}{3(a+b)}+\frac{a^2b}{a+b}}.
\end{esn}
...
\begin{esn}
\esp{\paren{\sup_{t\in [0,1]}\abs{B_t}}^2}=\lim_{n\rightarrow \infty}\esp{(\max_{k\in D_n}\abs{B _k})^2} \leq 4
\end{esn}
